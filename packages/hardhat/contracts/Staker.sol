...
contract Staker {
    ...
    modifier notCompleted() {
        require(exampleExternalContract.completed() == false, "The external contract is complete");
   ...
   function execute() public notCompleted {
       require(deadline <= block.timestamp, "The deadline has not been met yet.");
    ...
    function withdraw(address payable withdrawee) public notCompleted {
        ...
        require(msg.sender == withdrawee, "You cannot withdraw someone elses funds");
